...
tests/hip_unit_test.o: tests/hip_unit_test.cpp ds4_gpu.h
	$(HIPCC) $(HIPCCFLAGS) -c -o $@ tests/hip_unit_test.cpp

tests/hip_unit_test: tests/hip_unit_test.o ds4_hip.o ds4.o
	$(HIPCC) $(HIPCCFLAGS) -o $@ $^ $(HIP_LDLIBS)

hip-unit-test: tests/hip_unit_test
	./tests/hip_unit_test
